...
export default function EmployeesPage() {
    ...
    const renderStatusBadge = (status) => {
        ...
        if (st === 'active') {
            return (<span style={{ padding: '3px 8px', background: '#000000', color: '#ffffff', fontSize: 11, fontWeight: 700 }}>
          Active
        </span>);
        }
        if (st === 'probation') {
    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: 24, position: 'relative' }}>
      {/* Title & Action Header */}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input type="text" value={search} onChange={(e) => { setSearch(e.target.value); setCurrentPage(1); }} placeholder="Filter by name or Employee ID (e.g. EMP-101)..." style={{ border: 'none', background: 'transparent', outline: 'none', fontSize: 14, width: '100%' }}/>
        </div>

        {/* Department Filter Dropdown */}
        <div style={{ minWidth: 180 }}>
          <select value={selectedDept} onChange={(e) => { setSelectedDept(e.target.value); setCurrentPage(1); }} style={{ width: '100%', padding: '10px 14px', background: '#F7F6F3', border: '1px solid #E6E6E6', fontSize: 14, outline: 'none' }}>
        ...
        <div style={{ minWidth: 160 }}>
          <select value={selectedStatus} onChange={(e) => { setSelectedStatus(e.target.value); setCurrentPage(1); }} style={{ width: '100%', padding: '10px 14px', background: '#F7F6F3', border: '1px solid #E6E6E6', fontSize: 14, outline: 'none' }}>
      ...
      <div style={{ background: '#ffffff', border: '1px solid #E6E6E6', padding: 24 }}>
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
            ...
            <tbody>
              {paginatedData.map((emp, i) => (<tr key={emp.id || i} style={{ borderBottom: '1px solid #E6E6E6' }}>
                  ...
                  <td style={{ padding: '14px 12px', textAlign: 'right' }}>
                    <button onClick={() => handleOpenDetail(emp)} style={{
      ...
      {addModalOpen && (<div style={{
          ...
          <div style={{
            ...
            {formSuccess && (<div style={{ background: '#E6F4EA', border: '1px solid #CEEAD6', color: '#137333', padding: '12px 16px', fontSize: 13, fontWeight: 600, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
                <CheckCircle size={16}/> {formSuccess}
              </div>)}

            {formError && (<div style={{ background: '#FFF0F0', border: '1px solid #FFD0D0', color: '#D00000', padding: '12px 16px', fontSize: 13, fontWeight: 600, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <form onSubmit={handleAddSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <input type="text" required value={formData.first_name} onChange={(e) => setFormData({ ...formData, first_name: e.target.value })} placeholder="e.g. John" style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, marginBottom: 6, textTransform: 'uppercase' }}>Last Name *</label>
                  <input type="text" required value={formData.last_name} onChange={(e) => setFormData({ ...formData, last_name: e.target.value })} placeholder="e.g. Doe" style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} placeholder="john.doe@company.com" style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 700, marginBottom: 6, textTransform: 'uppercase' }}>Phone Number</label>
                  <input type="text" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder="+91 9876543210" style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <select value={formData.department} onChange={(e) => setFormData({ ...formData, department: Number(e.target.value) })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}>
                ...
                <div>
                  ...
                  <select value={formData.designation} onChange={(e) => setFormData({ ...formData, designation: Number(e.target.value) })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <select value={formData.employment_type} onChange={(e) => setFormData({ ...formData, employment_type: e.target.value })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}>
                ...
                <div>
                  ...
                  <input type="number" value={formData.basic_salary} onChange={(e) => setFormData({ ...formData, basic_salary: Number(e.target.value) })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div>
                  ...
                  <select value={formData.gender} onChange={(e) => setFormData({ ...formData, gender: e.target.value })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}>
                ...
                <div>
                  ...
                  <input type="date" value={formData.date_of_birth} onChange={(e) => setFormData({ ...formData, date_of_birth: e.target.value })} style={{ width: '100%', padding: '10px 12px', border: '1px solid #E6E6E6', background: '#F7F6F3', fontSize: 13, outline: 'none' }}/>
                </div>
              </div>

              {/* Actions */}
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12, marginTop: 12 }}>
                <button type="button" onClick={() => setAddModalOpen(false)} style={{ padding: '10px 20px', background: '#F1F3F4', color: '#3C4043', border: 'none', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
                  Cancel
                </button>
      ...
      {panelOpen && selectedEmp && (<div style={{
          ...
          <div style={{
            ...
            <button onClick={() => setPanelOpen(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 6, color: '#767676' }}>
              <X size={20}/>
            </button>
          </div>

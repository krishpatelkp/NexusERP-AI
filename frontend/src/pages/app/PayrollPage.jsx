...
export default function PayrollPage() {
    ...
    const [summary, setSummary] = useState({ total_payslips: 105, total_gross: 110000, total_net: 85000 });
    ...
    if (isAdmin) {
        ...
        <div style={{ background: '#ffffff', border: '1px solid #E6E6E6', padding: 24 }}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 }}>
              ...
              <tbody>
                {payrollRuns.map((run) => (<tr key={run.id} style={{ borderBottom: '1px solid #E6E6E6', cursor: 'pointer' }}>
        ...
        {selectedRun && (<div style={{ background: '#ffffff', border: '1px solid #000000', padding: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              ...
              <button onClick={() => setSelectedRun(null)} style={{ padding: '6px 12px', background: '#F7F6F3', border: '1px solid #E6E6E6', fontSize: 12, fontWeight: 600, cursor: 'pointer' }}>
                Close Inspection
              </button>
            </div>
      ...
      <div style={{ background: '#ffffff', border: '1px solid #E6E6E6', padding: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {payslips.length > 0 ? (payslips.map((slip, i) => {
            ...
            return (<div key={id} style={{ border: '1px solid #E6E6E6', background: '#ffffff' }}>
                  {/* Header Row */}
                  ...
                  {isExpanded && (<div style={{ padding: '20px 24px', borderTop: '1px solid #E6E6E6', background: '#F7F6F3' }}>

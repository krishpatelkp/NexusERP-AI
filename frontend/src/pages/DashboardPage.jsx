...
import { Users, Clock, CalendarDays, Wallet, Package, CreditCard, Bot, LogOut, Building2, ShieldCheck, Bell } from 'lucide-react';
    ...
    return (<div style={{ minHeight: '100vh', background: '#F7F6F3' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          {user && (<div style={{ display: 'flex', alignItems: 'center', gap: 12, fontSize: 13 }}>
        ...
        }} onMouseEnter={(e) => (e.currentTarget.style.background = '#F7F6F3')} onMouseLeave={(e) => (e.currentTarget.style.background = 'none')}>
      ...
      <main style={{ padding: '40px 0' }}>
        ...
        ].map((mod) => (<div key={mod.label} style={{
                background: '#fff',
                border: '1px solid #E6E6E6',
                padding: 20,
                display: 'flex',

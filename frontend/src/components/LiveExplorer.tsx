...
import {
  ...
  Bell, Search, RefreshCw, CheckCircle2, AlertCircle, Building2, ShieldCheck
} from 'lucide-react'

export default function LiveExplorer() {
  const [activeTab, setActiveTab] = useState<'employees' | 'attendance' | 'leave' | 'payroll' | 'inventory' | 'payments' | 'notifications'>('employees')
  ...
  return (
    <section id="explorer" className="section" style={{ background: '#F7F6F3', borderTop: '1px solid #E6E6E6' }}>
                  ...
                  <tbody>
                    {filteredEmployees.length > 0 ? (
                      filteredEmployees.slice(0, 15).map((emp) => (
                        <tr key={emp.id} style={{ borderBottom: '1px solid #E6E6E6' }}>
              ...
              {activeTab === 'leave' && (
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 14 }}>
                  ...
                  <tbody>
                    {leaves.length > 0 ? (
                      leaves.map((l) => (
                        <tr key={l.id} style={{ borderBottom: '1px solid #E6E6E6' }}>
              ...
              {activeTab === 'payroll' && (
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 14 }}>
                  ...
                  <tbody>
                    {payslips.length > 0 ? (
                      payslips.map((p) => (
                        <tr key={p.id} style={{ borderBottom: '1px solid #E6E6E6' }}>
              ...
              {activeTab === 'inventory' && (
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 14 }}>
                  ...
                  <tbody>
                    {assets.length > 0 ? (
                      assets.map((a) => (
                        <tr key={a.id} style={{ borderBottom: '1px solid #E6E6E6' }}>
              ...
              {activeTab === 'notifications' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  {notifications.length > 0 ? (
                    notifications.map((n) => (
                      <div key={n.id} style={{ padding: 16, background: n.is_read ? '#fff' : '#F7F6F3', border: '1px solid #E6E6E6', display: 'flex', justifyContent: 'space-between' }}>
                        <div>

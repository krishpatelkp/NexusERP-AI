...
export default function AICopilot() {
    ...
    return (<section id="ai" style={{ background: '#000', color: '#fff', padding: '140px 0' }}>
          ...
          <div>
            ...
            <FadeIn delay={200}>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {quickPrompts.map((prompt) => (<button key={prompt} disabled={loading} onClick={() => {
                setInput(prompt);
                handleSend(prompt);
            }} style={{
                padding: '8px 14px',
            ...
            }} onMouseEnter={e => { e.currentTarget.style.borderColor = '#fff'; e.currentTarget.style.color = '#fff'; }} onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.15)'; e.currentTarget.style.color = '#ccc'; }}>
          ...
          <FadeIn delay={100}>
            ...
            display: 'flex', alignItems: 'center', justifyContent: 'center',
              ...
              <div style={{ padding: 20, minHeight: 320, maxHeight: 380, overflowY: 'auto' }}>
                ...
                {loading && (<div style={{ display: 'flex', alignItems: 'center', gap: 8, color: '#999', fontSize: 13 }}>
            ...
            borderTop: '1px solid rgba(255,255,255,0.08)',
                ...
                <input type="text" value={input} disabled={loading} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleSend()} placeholder="Ask NexusERP AI (e.g. 'Who is absent today?')" style={{

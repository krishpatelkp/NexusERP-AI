...
import { LayoutDashboard, Users, Clock, CalendarDays, Wallet, Package, CreditCard, BarChart3, Bot, Settings, LogOut, Bell } from 'lucide-react';
...
export const AppLayout = ({ children }) => {
    ...
    return (<div style={{ minHeight: '100vh', display: 'flex', background: '#F7F6F3' }}>
      {/* 240px Sidebar */}
      <aside style={{
            width: 240,
            background: '#ffffff',
        ...
        }} onMouseEnter={(e) => (e.currentTarget.style.background = '#F7F6F3')} onMouseLeave={(e) => (e.currentTarget.style.background = '#ffffff')}>
